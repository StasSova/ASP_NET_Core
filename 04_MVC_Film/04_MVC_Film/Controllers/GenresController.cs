...
namespace _04_MVC_Film.Controllers
{
    public class GenresController : Controller
    {
        ...
        {
            _context = context;
            GenreNameValidatorAttribute.FilmContext = context;
        }
        ...
        public bool GenreNameValidator(string Name)
        {
            string[] ProhibitedGenres = ["test", "test2"];
            if (Name == null) return false;
            string? strval = Name.ToString().ToLower();
            return !ProhibitedGenres.Any(x => x == strval);
        }
    }
}
